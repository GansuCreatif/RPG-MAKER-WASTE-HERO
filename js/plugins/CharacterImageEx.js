/*!/*:
@target MZ
@plugindesc CharacterImageEx v1.1.1
@author unagi ootoro
@help
...
in the first Comment on the event page, you can set the display angle of the character image to the specified value.
